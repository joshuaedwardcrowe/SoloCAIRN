...
- `qa-checklist.md` per feature: the verified-by-a-human list. Lives in `features/<feature>/` in the SoloCAIRN repo.
...
- Project-wide checklists (accessibility, security baseline, performance baseline). These are project-level documentation, not SoloCAIRN; they live wherever your team keeps such things (typically `docs/checklists/` in the code repo).
...
**14:00.** Update `features/pub-quiz/qa-checklist.md` in the SoloCAIRN repo with the items the team agreed during the Story PR review.
