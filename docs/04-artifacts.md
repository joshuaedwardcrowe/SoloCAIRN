...
Every stage in SoloCAIRN produces at least one artifact. This is the catalog: what each artifact is for, who owns it, how long it should be, and how it ends.

Templates for each artifact live in [templates/](../templates/).

> All SoloCAIRN artifacts live in your chosen SoloCAIRN location: a separate SoloCAIRN repo (recommended) or a long-lived `cairn/<feature>` branch in your code repo. None of them ever land on the code repo's `main`. They end when the feature ships and stabilises. See [09-deployment-models.md](09-deployment-models.md).
>
> Throughout this catalog, **"ends with the feature"** is shorthand for: in the separate-repo model the feature folder is archived or deleted; in the branch model the long-lived branch PR is closed without merging. Either way, the git history of the chosen SoloCAIRN location remains as a historical record.

## The short list

If you only produce these, you have SoloCAIRN:
...
- **End of life.** Ends with the feature. The historical record remains in the SoloCAIRN location's git history.
...
SoloCAIRN deliberately does not own:
...
These are valuable artifacts. They are not feature-scoped. Whether and how your team maintains them is decided by your team or your company, not by SoloCAIRN. If you have them, they live wherever your team has decided. SoloCAIRN does not put them in the SoloCAIRN location and does not put them on `main` either; that is your call.

If your team has none of these today, SoloCAIRN does not require you to start. You can adopt SoloCAIRN purely as feature-build scaffolding without changing anything else.
...
Every file in your SoloCAIRN location has a cost. Pay it on purpose.
